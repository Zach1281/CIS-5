 ...
 * Created on October 28, 2018 5:51 PM
 * Purpose: Project 1
 */
...
int main() 
{
    ...
    int x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10;//dice roll variable
    int numC1, numC2, numC3;//player decision on number to choose for knock out
    int score11 = 0, score21 = 0, score12 = 0, score22 = 0, score13 = 0, score23 = 0;//trying to keep track of score with player and round respectively 
    srand(time(NULL));
    ...
    while (choice2 == 'Y' || choice2 == 'y')//another while loop for the choice to continue and break up the rounds
    {
        ...
        while (choice3 == 'Y' || choice3 == 'y')
        {
            ...
            cout << "Final Round!\n"; 
            cout << "Are you ready to enter the last round? Y/N?\n";
            cin >> choice4;
